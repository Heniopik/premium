...
ohp=$(systemctl status openvpn-udp | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
ohq=$(systemctl status openvpn-tcp | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
ohr=$(systemctl status openvpn-ssl | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
...
echo -e "⚙️ Trojan            :$status_virus_trojan"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo ""
